...
import { ArrowRightIcon, BuildingLibraryIcon, CubeIcon, ListBulletIcon, PresentationChartBarIcon, UserIcon, UsersIcon } from '@heroicons/react/24/solid'
                        ...
                        <div className="text-gray-900 dark:text-gray-100">
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 p-4">
                                <div className="sm:relative bg-white p-3 sm:p-6 dark:bg-gray-800 overflow-hidden shadow-md rounded-xl h-32 sm:h-60 flex sm:justify-center justify-evenly items-center flex-col gap-1">
                                    ...
                                    <Link href="" className="sm:sm:absolute hover:underline hover:font-bold bottom-4 right-5 text-sm rounded-full">
