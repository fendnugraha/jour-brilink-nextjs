...
import { Bars3Icon, MapPinIcon, UserCircleIcon } from '@heroicons/react/24/solid'
        ...
        <>
            ...
            <div className="pt-1 px-4 sm:px-6 flex items-center justify-end">
                <span className="text-sm text-slate-700 font-bold">
                    <UserCircleIcon className="w-5 h-5 inline" /> {user.name} <MapPinIcon className="w-5 h-5 inline" /> {user.role.warehouse.name}
                </span>
            </div>
            <div
