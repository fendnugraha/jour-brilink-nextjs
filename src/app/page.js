            ...
            <div className="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
                ...
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                            ...
                            <div className="p-6">
                                <div className="flex items-center">
                                    ...
                                    <div className="ml-4 text-lg leading-7 font-semibold">
                                        <a href="https://laravel.com/docs" className="underline text-gray-900 dark:text-white">
                                            Documentation
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="ml-12">
                                    <div className="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        ...
                                        framework or have previous experience with Laravel, we recommend reading all of the documentation from beginning to end.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="flex justify-center mt-4 sm:items-center sm:justify-between">
                        ...
                        <div className="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0">Laravel Breeze + Next.js template</div>
                    </div>
                </div>
            </div>
        </>
